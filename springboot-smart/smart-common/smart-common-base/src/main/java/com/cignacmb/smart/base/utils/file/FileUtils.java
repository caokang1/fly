package com.cignacmb.smart.base.utils.file;
...
public class FileUtils {
    ...
    public static String getAbsolutePath() throws IOException {
        return getFullPathRelateClass("../../../../../../", FileUtils.class);
    }
    ...
    private static URL getClassLocationURL(final Class<?> cls) {
        ...
        if (pd != null) {
            ...
            if (result != null) {
                /*
                 * Convert a code source location into a full class file location for some
                 * common cases:
                 */
        ...
        if (result == null) {
            /*
             * Try to find 'cls' definition as a resource; this is not document．d to be
             * legal, but Sun's implementations seem to //allow this:
             */
     ...
     * @return
     */
    public String separatorPath(String filePath) {
    ...
    /**
     * 针对Linux和windows下文件路径中/以及\的转换
     *
     * @param str
     * @return
     */
    public static String separatorFormat(String str) {
    ...
    public static String[] splitFileName(String fileName) {
        ...
        file[0] = fileName.substring(0, len);
        file[1] = fileName.substring(len + 1, fileName.length());
        return file;
    }

    /**
     * 将file 转换为MultipartFile
     *
     * @param file
     ...
     * @throws Exception
     */
    public static void downLoadFile(String filePath, String displayName, HttpServletResponse response)
            throws Exception {

        String path = FileUtils.separatorFormat(filePath);

        response.setContentType("application/octet-stream");
        response.setHeader("Content-Disposition",
                "attachment; filename=" + new String(displayName.getBytes(), "ISO8859-1"));


        File f = new File(path);

        if (!f.exists()) {
            throw new BusinessException("NOT FOUND THIS FILE ON SERVICES DISK!");
        }
